...
#   c) node1 mines 32 blocks, so now node 0 has 500000OPU, node 1 has 4250OPU, node2 has none.
#   d) node0 sends 601 OPU to node2, in two transactions (301 OPU, then 300 OPU).
