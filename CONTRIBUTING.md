Contributing to OpulenceCoin Core
==================================

The OpulenceCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OpulenceCoin Core project, and is not to be
confused with overall OpulenceCoin Network Protocol consensus changes.

Whether a pull request is merged into OpulenceCoin Core rests with the project merge
...
Patches that change OpulenceCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OpulenceCoin consensus, it must have been
...
The project leader is the release manager for each OpulenceCoin Core release.
