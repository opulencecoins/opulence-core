...
OpulenceCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<opulencecoin_address\> \<monthly_payment_opulencecoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ OPU, _12_ times over the course of a year totaling _24000_ OPU.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<opulencecoin_address\> \<monthly_payment_opulencecoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` OPU.
 ...
 * vote-many          - Vote on a OpulenceCoin initiative
 * vote-alias         - Vote on a OpulenceCoin initiative
 * vote               - Vote on a OpulenceCoin initiative/budget
