...
In order to support loading of multiple wallets in opulencecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is opulencecoin.cpp.
...
Changes to opulencecoin.cpp
----------------------
opulencecoin.cpp is the entry point into opulencecoin-qt, and as such, will require some minor modifications to provide hooks for
