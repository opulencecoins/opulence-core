...
Intro
-----
OpulenceCoin (OPU) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. OpulenceCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run opulencecoin-qt.exe.

OpulenceCoin Core is the original OpulenceCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of OpulenceCoin transactions;
