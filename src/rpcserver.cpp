...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OpulenceCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "OpulenceCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OpulenceCoin features */
        {"opulencecoin", "masternode", &masternode, true, true, false},
        {"opulencecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"opulencecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"opulencecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"opulencecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"opulencecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"opulencecoin", "startmasternode", &startmasternode, true, true, false},
        {"opulencecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"opulencecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"opulencecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"opulencecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"opulencecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"opulencecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"opulencecoin", "mnbudget", &mnbudget, true, true, false},
        {"opulencecoin", "preparebudget", &preparebudget, true, true, false},
        {"opulencecoin", "submitbudget", &submitbudget, true, true, false},
        {"opulencecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"opulencecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"opulencecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"opulencecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"opulencecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"opulencecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"opulencecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"opulencecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"opulencecoin", "mnsync", &mnsync, true, true, false},
        {"opulencecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> opulencecoin-cli " + methodname + " " + args + "\n";
}
