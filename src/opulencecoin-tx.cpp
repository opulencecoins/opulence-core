...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OpulenceCoin Core opulencecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  opulencecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded opulencecoin transaction") + "\n" +
                               "  opulencecoin-tx [options] -create [commands]   " + _("Create hex-encoded opulencecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded opulencecoin transaction
