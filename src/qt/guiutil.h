...
/** Utility functions used by the OpulenceCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render OPU addresses in monospace font
...
// Parse "opulencecoin:" URI into recipient object, return true on successful parsing
