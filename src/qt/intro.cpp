...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OpulenceCoin Core"),
     ...
     * override -datadir in the opulencecoin.conf file in the default data directory
     * (to be consistent with opulencecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
