...
// Copyright (c) 2018-2019 The OpulenceCoin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OpulenceCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OPU address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and opulencecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OpulenceCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OpulenceCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OpulenceCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OPU addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OPU addresses"));
    ...
    openAction->setStatusTip(tr("Open a opulencecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OpulenceCoin Core help message to get a list with possible OpulenceCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OpulenceCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OpulenceCoin network", "", count));
}
...
{
    QString strTitle = tr("OpulenceCoin Core"); // default title
