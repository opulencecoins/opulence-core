...
int nStakeTargetSpacing = 60; // OpulenceCoin: 1 minute blocks during POS (block 201+)
...
{
    // OpulenceCoin will hash in the transaction hash and the index number in order to make sure each hash is unique
