...
// Copyright (c) 2017 The OpulenceCoin developers
...
public:
    CMainParams()
    {
        ...
        pchMessageStart[1]             = 0x75; // p
        pchMessageStart[2]             = 0x82; // u
        pchMessageStart[3]             = 0x57; // c
        vAlertPubKey                   = ParseHex("0466fc8b5e8e639fcca5ab0b6c4325096de35611395b56485968b9f81b5241dc3d8e605a189ed0b136ad5f6a86f14f06458a9a9318f0771247545eef21071621ce");
        vAlertPubKeyOld                = ParseHex("046c5aa8b6d5319aed1b7a292a4a84a6e152c06c09b457dbafcd0aa62536965bbf6c64eea4223bf332c30331ae283f0b76d23f2fc06acd85c78f47b7fd861306d3");
        nDefaultPort                   = 3505;
        ...
        nTargetSpacingPOS              = 1  * 60;  // OpulenceCoin: 1 minute blocks during POS
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // OpulenceCoin: 1 day
        nTargetSpacing = 2 * 60;  // OpulenceCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet OpulenceCoin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet OpulenceCoin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet OpulenceCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet OpulenceCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet opulencecoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // OpulenceCoin: 1 day
        nTargetSpacing = 2 * 60;        // OpulenceCoin: 1 minutes
